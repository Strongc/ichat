...
// 获取区域信息
void get_region_info(const _request& req, _reply& rep);

// 获取用户列表
void get_user(const _request& req, _reply& rep);

// 获取用户信息
void get_user_info(const _request& req, _reply& rep);
...
{
    // 注册处理函数
    rest_fun_regist(std::string("^/api/state$"), user_state);
    rest_fun_regist(std::string("^/api/region$"), region_oper);
    rest_fun_regist(std::string("^/api/region/\\d{1,3}$"), get_region_info);
    rest_fun_regist(std::string("^/api/region/\\d{1,3}/user$"), get_user);
    rest_fun_regist(std::string("^/api/user/\\d{1,3}$"), get_user_info);
